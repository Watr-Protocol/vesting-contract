...
describe("VestingContract", () => {
    it("should return locked balance", async () => {
        ...
        const contract = await factory.deploy("0x98f457EDcd11dB513cBf631a759FD94E64066323", 3600, 4, "1000000000000000000", now)
    ...
    it("should allow withdrawal after unlocks", async () => {
        ...
        await time.increase(3601)
        await contract.withdraw("0x98f457EDcd11dB513cBf631a759FD94E64066323")
        const contractBalance = await ethers.provider.getBalance(contract.address)
        chai.expect(contractBalance).to.equal("750000000000000000")
        const payeeBalance = await ethers.provider.getBalance("0x98f457EDcd11dB513cBf631a759FD94E64066323")
